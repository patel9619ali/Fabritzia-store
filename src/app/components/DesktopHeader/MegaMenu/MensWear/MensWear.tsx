  ...
  return (
    ...
    <GlobalStyle />
        <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle drop_down_anchor" onClick={toggleDropdown} href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded={isOpenDropDown}>Men</a>
